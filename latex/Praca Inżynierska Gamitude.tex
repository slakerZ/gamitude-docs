...
\includegraphics[width=15 cm, left]{richpicture1.jpg}
\vspace{0.5cm}
Użytkownik przed skorzystaniem z systemu.\\
\includegraphics[width=15 cm, left]{richpicture2.jpg}
\vspace{0.5cm}
Użytkownik korzystający z systemu.\\
...
\vspace{0.5cm}
Use case dla całego systemu\\
\vspace{0.5cm}
\subsection{Diagramy}
\includegraphics[width=\textwidth, height=9cm]{sekwencji.png}\\
Diagram sekwencji dla dodawania projektu oraz włączania sesji\\
\vspace{0.5cm}
\includegraphics[width=\textwidth, height=9cm]{sekwencji1.png}\\
Diagram sekwencji dla załadowania strony Bullet Journal’a oraz usuwania zadania\\
\vspace{0.5cm}
\chapter {Planowanie}
...
Zmiana ProcjetLogs, by zapewnić spójność.\\
\subsection {Wykonane zadania}
Paweł: \\
Robert: \\
Stanisław: \\
