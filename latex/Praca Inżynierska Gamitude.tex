...
\begin{table}[H]
	...
	\hline
	Numer kroku & czynność wykonywana przez użytkownika & odpowiedź aplikacji. \\
	\hline
...
\begin{table}[H]
	...
	\hline
	Kryteria akceptacji: & \multicolumn{2}{|c|}{Pojawienie się rangi w zbiorze kupionych rang LUB komunikat, dlaczego nie można kupić rangi.} \\
	\hline
	\end{tabular}
\end{table}
\begin{table}[H]
