...
Komponent Bullet Journal Page został rozbity na kilka pomniejszych kompotentów.
 ...
 którego zadaniem jest wyrenderowanie zawartości każdego zadania tj. możliwość edycji zadania, możliwość usunięcia zadania, czy możliwość jego zakończenia.\\
 Komponenty AddJournalDialog i AddPageDialog są to komponenty typu dialog opisane w podrozdziale nr\ref{dialog},
...
\end{figure}
\subsubsection{Journal oraz Page}
Komponenty Journal i Page wykorzystują komponenty Tabs oraz TabPanel, które zostały zaprezentowane w podrozdziale nr\ref{subsec:tabs}.
Wszystkie dane potrzebne do wyrenderowania otrzymują od rodzica Bullet Journal Page,
 który wykonuje zapytania HTTP typu GET do API dzienników oraz stron.
Otrzymują one również funkcje 
