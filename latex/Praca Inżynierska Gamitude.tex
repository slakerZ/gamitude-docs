...
\multicolumn{2}{c}{\textbf{Praca dyplomowa}}\\
...
\textbf{Streszczenie:} & napisać coś o tym, jak bardzo chcemy zarządzać energią. \\
\end{tabular}
\newpage
...
\hline
\textbf{Temat projektu:}\\Gamitude zarządzaj swoją energią, a nie czasem\\ 
\hline
\textbf{Temat projektu w języku angielskim:}\\Gamitude manage your Energy, not your Time\\ 
\hline
\textbf{Akronim:}\\GTM\\
\hline
...
Aplikacja webowa kompatybilna z większością przeglądarek i komputerów z dostępem do Internetu.
 ...
 Bullet Journal czy Elastic Habits\cite{elastic}\cite{elasticHabits} wspierane przez system rang,
...
\end{itemize}
Kody komponentów formik-form oraz formik-field pokazane zostały na obrazku nr \ref{fig:formik_form} oraz \ref{fig_formik_field}.
\begin{figure}[H]
	\centering
...
\begin{figure}[H]
	...
	\includegraphics[scale=0.5]{implementacja/backend/gamitude_backend}}\\
	\caption{Skrócony diagram klas}
	\label{fig:gamitude_backend}
\end{figure}
\subsection{Endpoint'y API}
Wszystkie endpoint'y interfejsu Web API wraz z krótkim komentarzem przy każdym endpoint'ie widoczne na obrazkach nr 
...
Stanisław: Dokumentacja 5.1.2, 5.1.3, 5.1.4 - Projektowanie i architektura systemu \ref{fig:overwiearch}.\\
\subsection {Napotkane problemy}
