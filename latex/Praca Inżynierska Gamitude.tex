...
Stanisław: Rozpoznanie dotyczące kontroli wersji w EA.\\
\subsection {Napotkane problemy}
...
Stanisław: Naprawiony system rang, dodanie load balancer'a do projektu, by zoptymalizować go w Kubernetes'ie. \\
\subsection {Napotkane problemy}
Brak napotkanych problemów.
...
\section {Eksperymenty z Azure, ulepszanie parallax'a}
\subsection {Założenia sprintu}
