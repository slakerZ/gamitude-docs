...
3.wypełnić formularz rejestracyjny, | uaktywniony przycisk Register LUB komunikat o błętnie wypełnionych danych LUB komunikat o zajętym emailu i nazwie użytkownika
3.1.podać inny email, nazwę użytkownika, | uaktywniony przycisk Register
4.kliknąć przycisk „register” | Przejście do strony logowania oraz komunikat „Go to your email to confimr your account”
Kryteria akceptacji: użytkownik utworzył konto, oraz otrzymał emaila z potwierdzeniem rejestracji.
Logowanie
1.wejść na stronę główną, | Wyświetlono stronę główną
2.kliknąć przycisk „get started”, | wyświetlono podstronę sign up
...
Dodanie projektu
1.wcisnąć żółty przycisk + | Wyświetlono formularz dodawania projektu
2.wypełnić formularz dodawania projektu oraz wciśnięcie przycisku submit | zamknięcie formularza, komunikat "succesfully created project" i odświerzenie listy projektów LUB komunikat "Incorrect data"
...
Kryteria akceptacji: Pomyślnie utworzono projekt.
dodanie katalogu
dodanie dziennika
dodanie strony
dodanie zadania
