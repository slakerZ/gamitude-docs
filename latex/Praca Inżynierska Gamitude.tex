...
\section{Technologie}
%Rozpisać na 2 zdania każdą z technologi, dlaczego została wybrana
		\begin{itemize}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{implementacja/frontend/redux_logger}\\
...
\end{figure}
\section{Testy walidacyjne (forma scenariuszy, brakuje założeń wstępnych, założeń końcowych, oczekiwany wynik)}
Rejestracja\\
...
Kryteria akceptacji: użytkownik utworzył konto, oraz potwierdził rejestrację.\\
Logowanie\\
1.wejść na stronę główną, | Wyświetlono stronę główną\\
2.kliknąć przycisk „get started”, | wyświetlono podstronę sign up\\
...
Kryteria akceptacji: Wyświetlenie strony Gamitude Projects ze stanem konta użytkownika\\
Dodanie projektu\\
...
Kryteria akceptacji: Dodanie nowego projektu z ustawionymi parametrami.\\
Dodanie katalogu\\
1.udać się do gamitude projects | wyświetlono podstronę gamitude projects\\
...
Kryteria akceptacji: Dodanie nowego katalogu z ustawionymi parametrami.\\
Dodanie dziennika\\
...
Kryteria akceptacji: Dodanie nowego dziennika z ustawionymi parametrami.\\
Dodanie strony\\
1.udać się do Bullet Journal | wyświetlono podstronę Bullet Journal\\
2.wcisnąć przycisk + pod stronami | Wyświetlono formularz dodawania stron\\
3.wypełnić formularz dodawania stron oraz wciśnięcie przycisku submit | zamknięcie formularza i odświerzenie listy stron LUB komunikat "Failed to create new page"\\
3.1 poprawienie danych i ponowne kliknięcie przycisku submit | zamknięcie stron i odświerzenie listy stron\\
Kryteria akceptacji: Dodanie nowej strony z ustawionymi parametrami.\\
Dodanie zadania\\
1.udać się do Bullet Journal | wyświetlono podstronę Bullet Journal\\
2.wcisnąć żółty przycisk + | Wyświetlono formularz dodawania zadania\\
3.wypełnić formularz dodawania dzienników oraz wciśnięcie przycisku submit | zamknięcie formularza i odświerzenie listy zadań LUB komunikat "Failed to create new task"\\
3.1 poprawienie danych i ponowne kliknięcie przycisku submit | zamknięcie formularza i odświerzenie listy zadań\\
Kryteria akceptacji: Dodanie nowego zadania z ustawionymi parametrami.\\
Zakup Rangi\\
...
Kryteria akceptacji: Pojawienie się rangi w zbiorze kupionych rang LUB komunikat o dlaczego nie można kupić rangi.\\
Zmiana Hasła\\
...
Kryteria akceptacji: Zmiana hasła.\\
Zmiana Emaila\\
1. Wejść na stronę ustawień użytkownika, | Wyświetlono stronę ustawień użytkownika\\
...
3. Wypełnić formularz zmiany emaila, | Odblokowano przycisk submit
 ...
 LUB Wyświetlono komunikat nie niepowodzeniu zmiany maila\\
4. Wyświetlono komunikat o wysłaniu potwierdzenia na podanego mail'a\\
5. Kliknięto potwierdzenie w mail'u | Przeniesiono na stronę wyświetlającą komunikat o poprawnej zmianie mail'a\\
Kryteria akceptacji: Zmieniony został email.\\
Usuń Projekt\\
...
Kryteria akceptacji: Usunięto projekt.\\
Usuń Zadanie\\
...
4. Kliknąć na wybrane zadanie w miejscu innym niż nazwa i radio, | zadanie rozwinęło się, ukazując formularz edycji\\
5. Kliknąć przycisk "Delete Task" | usunięto zadanie oraz odświerzono listę zadań na stronie\\
Kryteria akceptacji: Usunięto zadanie.\\
